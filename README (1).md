...
At inference, predictions are averaged over **7 augmented views** of each frame (flips/crops). TTA alone raises accuracy from **76.27%** to **80.51%** and is the default reported configuration.

**Top-2 Accuracy:**
In addition to standard metrics, Top-2 accuracy (the correct class is among the model's two highest-scoring guesses) reaches **94.02%** useful for a triage tool where a short shortlist is acceptable.
...
|---|---|---|
| Accuracy | 76.27% | **80.51%** |
| Macro-F1 | 0.758 | **0.807** |
| OvR Macro-AUC | | **0.965** |
...
|---|---|---|---|
| Real | 0.73 | 0.89 | 0.80 |
| Deepfakes | 0.77 | 0.75 | 0.76 |
| Face2Face | 0.96 | 0.77 | 0.85 |
| FaceSwap | 0.96 | 0.84 | 0.90 |
| NeuralTextures | 0.77 | 0.68 | 0.72 |

> FaceSwap and Face2Face are the cleanest classes; NeuralTextures is the hardest the price of covering every manipulation plus real in one model. Test-time augmentation adds about +4% accuracy.
## Visualizations
